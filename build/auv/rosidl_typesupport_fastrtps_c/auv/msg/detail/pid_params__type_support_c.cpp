...
#include "auv/msg/detail/pid_params__rosidl_typesupport_fastrtps_c.h"
...
using _PidParams__ros_msg_type = auv__msg__PidParams;
...
size_t get_serialized_size_auv__msg__PidParams(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PidParams__ros_msg_type * ros_message = static_cast<const _PidParams__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _PidParams__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_auv__msg__PidParams(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_auv
size_t max_serialized_size_auv__msg__PidParams(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_auv__msg__PidParams(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, auv, msg, PidParams)() {

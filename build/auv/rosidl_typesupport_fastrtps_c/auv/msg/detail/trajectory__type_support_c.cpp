...
#include "auv/msg/detail/trajectory__rosidl_typesupport_fastrtps_c.h"
...
using _Trajectory__ros_msg_type = auv__msg__Trajectory;
...
static uint32_t _Trajectory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_auv__msg__Trajectory(
...
{
  return max_serialized_size_auv__msg__Trajectory(
    full_bounded, 0);
}

...
#include "auv/msg/detail/orientation__rosidl_typesupport_fastrtps_c.h"
...
using _Orientation__ros_msg_type = auv__msg__Orientation;
...
static uint32_t _Orientation__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_auv__msg__Orientation(
...
{
  return max_serialized_size_auv__msg__Orientation(
    full_bounded, 0);
}

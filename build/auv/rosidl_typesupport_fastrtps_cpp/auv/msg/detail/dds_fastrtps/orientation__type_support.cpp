...
#include "auv/msg/detail/orientation__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const auv::msg::Orientation *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<auv::msg::Orientation *>(
    untyped_ros_message);
...
{
  return &auv::msg::typesupport_fastrtps_cpp::_Orientation__handle;
}

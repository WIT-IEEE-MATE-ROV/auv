...
#include "auv/msg/detail/thruster_move__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const auv::msg::ThrusterMove & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  auv::msg::ThrusterMove & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_auv
max_serialized_size_ThrusterMove(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const auv::msg::ThrusterMove *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<auv::msg::ThrusterMove *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ThrusterMove__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const auv::msg::ThrusterMove *>(
...
{
  return max_serialized_size_ThrusterMove(full_bounded, 0);
}

static message_type_support_callbacks_t _ThrusterMove__callbacks = {
  "auv::msg",
  "ThrusterMove",
...
static rosidl_message_type_support_t _ThrusterMove__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ThrusterMove__callbacks,
...
get_message_type_support_handle<auv::msg::ThrusterMove>()
{
  return &auv::msg::typesupport_fastrtps_cpp::_ThrusterMove__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, auv, msg, ThrusterMove)() {
  return &auv::msg::typesupport_fastrtps_cpp::_ThrusterMove__handle;
}

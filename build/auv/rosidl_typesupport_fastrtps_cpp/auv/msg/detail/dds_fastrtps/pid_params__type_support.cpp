...
#include "auv/msg/detail/pid_params__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const auv::msg::PidParams & ros_message,
...
{
  auto typed_message =
    static_cast<const auv::msg::PidParams *>(
    untyped_ros_message);
...
{
  return &auv::msg::typesupport_fastrtps_cpp::_PidParams__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, auv, msg, PidParams)() {
  return &auv::msg::typesupport_fastrtps_cpp::_PidParams__handle;
}

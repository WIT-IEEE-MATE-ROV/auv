...
#include "auv/msg/detail/translation__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const auv::msg::Translation & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  auv::msg::Translation & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const auv::msg::Translation *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<auv::msg::Translation *>(
    untyped_ros_message);
...
static size_t _Translation__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_Translation(full_bounded, 0);
}
...
{
  return &auv::msg::typesupport_fastrtps_cpp::_Translation__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, auv, msg, Translation)() {
  return &auv::msg::typesupport_fastrtps_cpp::_Translation__handle;
}

...
bool auv__msg__thruster_sensor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("auv.msg._thruster_sensor.ThrusterSensor", full_classname_dest, 39) == 0);
  }
  auv__msg__ThrusterSensor * ros_message = _ros_message;
  {  // header
  ...
  {  // rpm
    ...
    ros_message->rpm = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // current
...
{
  /* NOTE(esteve): Call constructor of ThrusterSensor */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("auv.msg._thruster_sensor");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ThrusterSensor");
  ...
  {  // rpm
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->rpm);
    {

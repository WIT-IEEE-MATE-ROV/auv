...
static const _ThrusterMove_type_support_symbol_names_t _ThrusterMove_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, auv, msg, ThrusterMove)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, auv, msg, ThrusterMove)),
  }
};
...
{
  return &::auv::msg::rosidl_typesupport_cpp::ThrusterMove_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, auv, msg, ThrusterMove)() {
  return get_message_type_support_handle<auv::msg::ThrusterMove>();
}

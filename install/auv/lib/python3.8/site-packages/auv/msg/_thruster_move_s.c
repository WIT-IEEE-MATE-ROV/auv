...
bool auv__msg__thruster_move__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("auv.msg._thruster_move.ThrusterMove", full_classname_dest, 35) == 0);
  }
  auv__msg__ThrusterMove * ros_message = _ros_message;
  {  // header
  ...
  {  // top_front
    PyObject * field = PyObject_GetAttrString(_pymsg, "top_front");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->top_front = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // top_back
    PyObject * field = PyObject_GetAttrString(_pymsg, "top_back");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->top_back = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // top_left
    ...
    assert(PyFloat_Check(field));
    ros_message->top_left = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // top_right
    ...
    assert(PyFloat_Check(field));
    ros_message->top_right = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // front_left
...
{
  /* NOTE(esteve): Call constructor of ThrusterMove */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("auv.msg._thruster_move");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ThrusterMove");
  ...
  {  // top_front
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->top_front);
    {
      int rc = PyObject_SetAttrString(_pymessage, "top_front", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // top_back
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->top_back);
    {
      int rc = PyObject_SetAttrString(_pymessage, "top_back", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // top_left
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->top_left);
    {
  ...
  {  // top_right
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->top_right);
    {

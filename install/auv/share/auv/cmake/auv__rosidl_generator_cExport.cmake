...
foreach(_expectedTarget auv::auv__rosidl_generator_c)
...
# Create imported target auv::auv__rosidl_generator_c
add_library(auv::auv__rosidl_generator_c SHARED IMPORTED)
...
file(GLOB CONFIG_FILES "${_DIR}/auv__rosidl_generator_cExport-*.cmake")

...
const_array_x = rospy.get_param('Thrusters/const_array_x') # x

const_array_y = rospy.get_param('Thrusters/const_array_y') #y

const_array_z = rospy.get_param('Thrusters/const_array_z') #z

const_array_roll = rospy.get_param('Thrusters/const_array_roll') #roll

const_array_pitch = rospy.get_param('Thrusters/const_array_pitch') #pitch

const_array_cut = rospy.get_param('Thrusters/const_array_cut') #cut
